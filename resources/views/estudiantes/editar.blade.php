        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="md-form md-outline">
                    ...
                    <input id="emailRepresentante" type="email" class="form-control @error('emailRepresentante') is-invalid @enderror" name="emailRepresentante" value="{{ old('emailRepresentante',$est->user->email_representante) }}" autocomplete="emailRepresentante" required>
